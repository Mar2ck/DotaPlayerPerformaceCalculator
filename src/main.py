...
def SetUpMatch():
    ...
    while (menuChoice != "9"):
        ...
        if (len(team1) > 0 and len(team2) > 0):
            prob = player_performance_score.GetProbability(player_performance_score.AveragePPS(team1),player_performance_score.AveragePPS((team2))) ##Gets the probability of winning
